Feature: Edgecases in Human Lives
  Scenario: Life of Alice the Entrepreneur
    ...
    And Alice became director of branches in US, Russia, and France as a founder
      ...
      | AcmeCorp-RU       | RU20081010FAUX      | RU              | _Алиса_  | DE19841010FAUX | DE               |
    ...
    And Alice founded a Not for Profit in UK and Russia, to help children get access to crude oil
      ...
      | ФондюФонд | 2009-10-10    | RU      | Not For Profit    | RUNGO20091010FAUX   |                           |
    And With following shareholder structure for the non profits, after she invited some large corporations
      ...
      | ФондюФонд | RUNGO20091010FAUX   | RU              | Legal Person   | FondueFoundation | GBNGO20091010FAUX | GB                  | 20     |
      | ФондюФонд | RUNGO20091010FAUX   | RU              | Legal Person   | AcmeCorp-GB      | GB20071010FAUX    | GB                  | 20     |
      | ФондюФонд | RUNGO20091010FAUX   | RU              | Natural Person | Alice            | GB19841010FAUX    | GB                  | 20     |
      | ФондюФонд | RUNGO20091010FAUX   | RU              | Legal Person   | GazProm          | RU19921010FAUX    | RU                  | 20     |
      | ФондюФонд | RUNGO20091010FAUX   | RU              | Legal Person   | AcmeCorp         | DE20061010FAUX    | DE                  | 20     |
